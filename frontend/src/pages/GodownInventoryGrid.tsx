...
const WARRANTY_STATUSES: { value: string; label: string; color: 'default' | 'success' | 'warning' | 'danger' | 'info' }[] = [
  { value: 'ACTIVE_WARRANTY', label: 'Active Warranty', color: 'success' },
  { value: 'ACTIVE', label: 'Active', color: 'success' },
  { value: 'UNDER_REPAIR', label: 'Under Repair', color: 'warning' },
  { value: 'OUT_OF_WARRANTY', label: 'Out of Warranty', color: 'danger' },
  { value: 'EXPIRED', label: 'Expired', color: 'danger' },
];

export function GodownInventoryGrid() {
  ...
  return (
    <Card>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 pb-4 border-b dark:border-gray-700">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Godown / Inventory Stock Grid</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage inventory units across all godowns</p>
        </div>
